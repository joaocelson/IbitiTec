...
public class UtilidadeAdapterFarmacia extends BaseAdapter {

    public static final String TAG = "UTILIDADE";
    private Context context;
    private Activity activity;

    private ArrayList<UtilidadePublicaFarmacia> listaUtilidades;
    private final int MY_PERMISSIONS_REQUEST_CALL_PHONE = 12;

    public UtilidadeAdapterFarmacia(Context context, ArrayList<UtilidadePublicaFarmacia> listaUtilidades, Activity activity) {
    ...
    public View getView(int position, final View convertView, ViewGroup parent) {
        try {
            final UtilidadePublicaFarmacia utilidade = listaUtilidades.get(position);
            ...
            View layout = inflater.inflate(R.layout.adapter_utilidade_farmacia, null);

            TextView dia = (TextView) layout.findViewById(R.id.txtDiaUtilidade);
            dia.setText(utilidade.getDiaUtilidade());
       ...
       //     ImageButton btnCall = (ImageButton) layout.findViewById(R.id.btn_image_button);
            ...
            Log.i(UtilidadeAdapterFarmacia.TAG, "Erro ao preecnher o getView: " + e.getMessage());

        }
        return convertView;
    }

    private void discar(View v, UtilidadePublicaFarmacia utilidade) {
